        ...
        <div class="card-sm">
            <div class="card-body">
                ...
                <div class="mb-4 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="col-11">
                        <h4 class="text-center"><b>Transaksi Barang Masuk</b></h4>
                ...
                <div class="mt-5 mb-3 d-flex flex-row align-items-center justify-content-between">
                    <table class="col-6">
                        <tr>
                            ...
                            <td>:</td>
                            <td><?= $brgmasuk['id_brgmasuk']; ?></td>
                        </tr>
                        <tr>
                            <th>Tanggal</th>
                            <td>:</td>
                            <td><?= date('l, d F Y H:i', strtotime($brgmasuk['created_at'])); ?></td>
                        </tr>
                    </table><br>
                    <table class="col-6">
                        <tr>
