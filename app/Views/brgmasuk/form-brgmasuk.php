...
<main>
    <div class="container-fluid">
        <h3 class="mt-4">Tambah Barang Masuk</h3>
        ...
        <!-- form Transaksi -->
        <form action="/admin/brgmasuk/simpan" method="POST">
            <div class="row mb-4 justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" disabeled class="form-control-plaintext id-brgmasuk" id="id_brgmasuk" name="id_brgmasuk" value="<?= $kode; ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-2">
                            <img class="img-thumbnail img-preview " src="/assets/img/default.jpg" alt="">
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                if ($item != 0) {
                                    ...
                                    foreach ($item as $it) : ?>
                                        <tr>
                                            ...
                                            <td><a href="/admin/brgmasuk/deleteCart/<?= $it['id_barang']; ?>" class="btn btn-sm btn-delete"><i class="fa fa-trash mx-1"></i></a></td>
                                        </tr>
                                <?php $i++;
                                    endforeach;
                                } ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <?php if ($item != 0) : ?>
                                <input type="text" readonly class="form-control-plaintext count-item" value="<?= count($item); ?>">
                            <?php endif; ?>
                        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $br) : ?>
                                <tr>
                                    ...
                                    <td><?= $br['stok']; ?></td>
                                    <td>
                                        <a href="/admin/brgmasuk/addCart/<?= $br['id_barang']; ?>" class="btn btn-sm btn-info"><i class="fa fa-plus-square mr-2"></i>Tambah</a>
