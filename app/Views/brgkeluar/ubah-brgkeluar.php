...
<main>
    <div class="container-fluid">
        <h3 class="mt-4">Ubah Barang Keluar</h3>
        ...
        <!-- form Transaksi -->
        <form action="/admin/brgkeluar/update" method="POST">
            <div class="row mb-4 justify-content-between">
                <div class="col-lg-6">
                    <div class="mb-3 row">
                        <label for="tanggal" class="col-sm-3 col-form-label">Tanggal</label>
                        <div class="col-sm-9">
                            <input type="text" disabled class="form-control-plaintext" id="tanggal" name="tanggal" value="<?= date('l, d F Y', strtotime($brgkeluar['created_at'])); ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="id_brgkeluar" class="col-sm-3 col-form-label">Kode Keluar</label>
                        <div class="col-sm-9">
                            <input type="text" disabeled class="form-control-plaintext id-brgkeluar" id="id_brgkeluar" name="id_brgkeluar" value="<?= $brgkeluar['id_brgkeluar']; ?>">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                                ...
                                if ($item != 0) {
                                    ...
                                    foreach ($item as $it) : ?>
                                        <tr>
                                            ...
                                            <td><a href="/admin/brgmasuk/deleteCart/<?= $it['id_barang']; ?>" class="btn btn-sm btn-delete hapus-item"><i class="fa fa-trash mx-1"></i></a></td>
                                        </tr>
                                <?php $i++;
                                    endforeach;
                                } ?>
